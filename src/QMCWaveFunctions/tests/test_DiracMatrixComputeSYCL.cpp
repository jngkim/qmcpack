...
TEST_CASE("DiracMatrixComputeSYCL_different_batch_sizes", "[wavefunction][fermion]")
{
...
TEST_CASE("DiracMatrixComputeSYCL_large_determinants_against_legacy", "[wavefunction][fermion]")
{
  int n = 64;
